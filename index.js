...
function createNewBookTask(book) {
 let newTask = document.createElement('li');
 newTask.innerHTML = '<span class="editable" contentEditable="true">' + book.name + "</span><input type='checkbox' class='remove-button'>"
//newTask.addEventListener('click', remove)
 document.getElementById("list").appendChild(newTask);
}
...
if(event.code === 'Enter') {
  ...
  event.srcElement.parentElement.innerHTML = value
  }
}
